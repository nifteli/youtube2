...
class Categories
{
	...
	public function __construct($controller)
	{
		...
		$this->categories->assign("catsHow",$controller->getCategories(1));
		$this->categories->assign("catsWhy",$controller->getCategories(2));
		$this->categories->assign("catsWhat",$controller->getCategories(4));
		$this->categories->assign("catsWho",$controller->getCategories(8));
	}
