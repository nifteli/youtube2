...
<head>
    ...
    <script src="./js/admin/trirand/i18n/grid.locale-en.js" type="text/javascript"></script>
    <script src="./js/admin/trirand/jquery.jqGrid.min.js" type="text/javascript"></script> 
	...
	<!--Grid-->
	<link rel="stylesheet" href="css/admin/grid/design.css"/>
